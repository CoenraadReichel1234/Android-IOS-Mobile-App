...
class AddNumPage3 extends StatelessWidget {
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    labelText: 'Pitte Getel', hintText: '/10 m'),
              ),
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: () {
                  ...
                  if (num1 != 0 && num2 != 0) {
                    double result = 100 / num1 * num2 * 10;

                    showDialog(
                      context: context,
                      builder: (context) => AlertDialog(
                        title: Text('Result'),
                        content: Text('$result plante/ha'),
                        actions: [
                          TextButton(
                            onPressed: () {
